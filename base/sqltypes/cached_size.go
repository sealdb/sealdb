...
import hack "github.com/forcedb/forcedb/base/hack"
...
func (cached *Result) CachedSize(alloc bool) int64 {
	...
	// field Fields []*github.com/forcedb/forcedb/base/vt/proto/query.Field
	{
	...
	// field Rows [][]github.com/forcedb/forcedb/base/sqltypes.Value
	{
